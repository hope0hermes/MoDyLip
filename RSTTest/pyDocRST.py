...
.. py:module:: pyDocRST
    :synopsis: Program to check the compatibility of docstrings and
        reStructuredText to create documentation for my python programs.
    :platform: Unix

.. moduleauthor:: Israel Barragan.
